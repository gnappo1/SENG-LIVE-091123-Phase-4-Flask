"""add cascading behavior on foreign key

Revision ID: 411ab29b6d7c
Revises: 
Create Date: 2023-11-16 10:37:38.840581
...
def upgrade():
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['production_id'], ['productions.id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
